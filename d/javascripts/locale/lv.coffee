App.lang.strings.lv =
  ...
  'Timer instructions': """
    <p>Ievadi minūtes (ja atšķiras no 45) un spied "Sākt".</p>
    <p>"Pauze", ja nepieciešams uzpauzēt, piespied otro reizi, lai turpinātu skaitīt.</p>
  """

  'Tournament data instruction': """
    <p>Ievadi pirmo vārdu un nospied < Enter >, tad ievadi kārtas (jeb raundus/posmus) ar pogu "Vēl kārta" (parasti 6).
