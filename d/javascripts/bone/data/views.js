...
(function() {
  ...
  window.Zole = Zole = (function(_super) {
    ...
    function Zole() {
      ...
      return Zole.__super__.constructor.apply(this, arguments);
    }
    ...
    Zole.prototype.events = {
      ...
      'click #order': 'reOrder',
      'click #discart': function() {
        return this.discard(1);
      },
      'click #discart-2': function() {
        return this.discard(2);
      },
      'keyup input': 'keyUp'
    };
    ...
    Zole.prototype.initialize = function() {
      var updateFoot;
      this.collection.bind('reset', (function(_this) {
        return function() {
    ...
    Zole.prototype.discard = function(how) {
      if (how == null) {
        how = 1;
      }
      if (this._discard_previous === how) {
        how = null;
      }
      this._discard_previous = how;
      this.collection.discard(how);
      return this.collection.each(function(m) {
